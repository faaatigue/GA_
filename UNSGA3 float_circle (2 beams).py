...
plt.grid(True)
plt.savefig('out3/0-Evolution of Fitness.png', dpi=300)
plt.show()
...
plt.colorbar()
plt.savefig('out3/1-Phase matrix.png', dpi=300)
plt.show()
...
# Display the plot
plt.savefig('out3/2-Radiation patterns.png', dpi=300)
plt.show()
...
plt.savefig('out3/3-3dB Area.png', dpi=300)
plt.show()
...
plt.axis('off')
plt.title('Over -3dB Area')
plt.savefig('out3/6-3dB Area (only).png', dpi=300)
plt.show()
...
plt.savefig('out3/4-Masks.png', dpi=300)
plt.show()
...
plt.savefig('out3/5-Check SLL.png', dpi=300)
plt.show()
...
# File path
csv_file_path = 'out3/UNSGA3 float_circle (2 beams).csv'
