...
plt.grid(True)
plt.savefig('out2_0-Evolution of Fitness.png', dpi=300)
plt.show()
...
plt.colorbar()
plt.savefig('out2_1-Phase matrix.png', dpi=300)
plt.show()
...
# Display the plot
plt.savefig('out2_2-Radiation patterns.png', dpi=300)
plt.show()
...
# plt.savefig('out2_3-3dB Area.png', dpi=300)
plt.show()
...
plt.axis('off')
plt.title('Over -3dB Area')
# plt.savefig('out2_6-3dB Area (only).png', dpi=300)
plt.show()
...
# plt.savefig('out2_4-Masks.png', dpi=300)
plt.show()
...
# plt.savefig('out2_5-Check SLL.png', dpi=300)
plt.show()
...
# File path
csv_file_path = 'out2_UNSGA3 float_circle.csv'
