...
plt.grid(True)
plt.savefig('out4_0-Evolution of Fitness.png', dpi=300)
plt.show()
...
plt.colorbar()
plt.savefig('out4_1-Phase matrix.png', dpi=300)
plt.show()
...
# Display the plot
plt.savefig('out4_2-Radiation patterns.png', dpi=300)
plt.show()
...
# plt.savefig('out4_3-3dB Area.png', dpi=300)
plt.show()
...
plt.axis('off')
plt.title('Over -3dB Area')
# plt.savefig('out4_6-3dB Area (only).png', dpi=300)
plt.show()
...
# plt.savefig('out4_4-Masks.png', dpi=300)
plt.show()
...
# plt.savefig('out4_5-Check SLL.png', dpi=300)
plt.show()
...
# File path
csv_file_path = 'out4_UNSGA3 float_circle.csv'
