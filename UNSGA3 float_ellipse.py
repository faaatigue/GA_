...
Theta_hp = np.radians(15)
Theta_fn = np.radians(18)
SLL = -20
...
plt.grid(True)
plt.savefig('out1_0-Evolution of Fitness.png', dpi=300)
plt.show()
...
plt.colorbar()
plt.savefig('out1_1-Phase matrix.png', dpi=300)
plt.show()
...
# Display the plot
plt.savefig('out1_2-Radiation patterns.png', dpi=300)
plt.show()
...
values2[np.nonzero(np.isclose(values2, 0, atol=1e-1))] = 0
...
plt.savefig('out1_3-3dB Area.png', dpi=300)
plt.show()
...
plt.axis('off')
plt.title('Over -3dB Area')
plt.savefig('out1_6-3dB Area (only).png', dpi=300)
plt.show()
...
values3[np.nonzero(np.isclose(E_L, 1, atol=1e-2, rtol=1e-2))] = -12.5
values3[np.nonzero(np.isclose(E_U, 1, atol=1e-2, rtol=1e-2))] = 0
...
plt.savefig('out1_4-Masks.png', dpi=300)
plt.show()
...
plt.savefig('out1_5-Check SLL.png', dpi=300)
plt.show()
...
# File path
csv_file_path = 'out1_UNSGA3 float_ellipse.csv'
